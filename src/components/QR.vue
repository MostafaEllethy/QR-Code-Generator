  ...
  <div>
    ...
    <div class="row">
      ...
      <div class="col-sm-8 col-9">
        <q-slider v-model="quality" :min="minQuality" :max="maxQuality" :step="5" color="indigo-10"
          :disable="downloading" aria-label="size slider" />
      </div>
    </div>
    <div class="row text-weight-bold" style="font-size:0.825rem;">
      <div class="col-4">
        <q-input filled v-model.number="quality" dense :input-style="{textAlign: 'center'}" />
      </div>
    ...
    <q-separator spaced />
    <q-btn-dropdown class="full-width q-pa-xs" color="positive" label="Download" icon="get_app" ref="DownloadPopup"
      :disable="downloading" :loading="downloading">
